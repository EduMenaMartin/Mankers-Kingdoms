...
8. **Player character stat rolling.** ~~Random like NPCs, point-buy, or hybrid? NPCs are random for variety; players may want more control.~~ **RESOLVED (revised):** Players roll each stat via 3d6 three times, keeping the highest — an intentional asymmetry from NPCs, who still use flat single 3d6. See `docs/gdd/character-creation.md` §10 and §5.
